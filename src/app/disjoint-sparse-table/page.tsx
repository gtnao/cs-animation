...
export default function DisjointSparseTablePage() {
  return (
    <div className="min-h-screen bg-background">
      <div className="max-w-2xl mx-auto px-4 py-16">
        <h1 className="text-2xl font-bold mb-2">Disjoint Sparse Table</h1>
        <p className="text-sm text-muted-foreground mb-8">
          半群に対する静的な区間クエリを O(1) で処理するデータ構造
        </p>
        <div className="space-y-2">
          <Link
            href="/disjoint-sparse-table/animation"
          ...
          <Link
            href="/disjoint-sparse-table/article"
            className="block p-4 border border-border rounded hover:bg-accent transition-colors"
          >
