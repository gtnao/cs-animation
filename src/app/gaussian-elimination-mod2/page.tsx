...
export default function GaussianEliminationMod2Page() {
  return (
    <div className="min-h-screen bg-background">
      <div className="max-w-2xl mx-auto px-4 py-16">
        <h1 className="text-2xl font-bold mb-2">ガウスの消去法 mod 2 ビット</h1>
        <p className="text-sm text-muted-foreground mb-8">
          GF(2) 上でのビット演算によるガウスの消去法
        </p>
        <div className="space-y-2">
          <Link
            href="/gaussian-elimination-mod2/animation"
          ...
          <Link
            href="/gaussian-elimination-mod2/article"
            className="block p-4 border border-border rounded hover:bg-accent transition-colors"
          >
