...
export default function CatalanNumberPage() {
  return (
    <div className="min-h-screen bg-background">
      <div className="max-w-2xl mx-auto px-4 py-16">
        <h1 className="text-2xl font-bold mb-2">カタラン数</h1>
        <p className="text-sm text-muted-foreground mb-8">
          括弧の組み合わせや二分木の数など多くの組合せ問題に現れる数列
        </p>
        <div className="space-y-2">
          <Link
            href="/catalan-number/animation"
