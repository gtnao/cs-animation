  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="max-w-2xl mx-auto px-4 py-16">
        <h1 className="text-2xl font-bold mb-2">橋・関節点検出</h1>
        <p className="text-sm text-muted-foreground mb-8">
          DFSのlow-link値を用いてグラフの橋と関節点を検出するアルゴリズム
        </p>
        <div className="space-y-2">
          <Link
            href="/bridges-articulation/animation"
          ...
          <Link
            href="/bridges-articulation/article"
            className="block p-4 border border-border rounded hover:bg-accent transition-colors"
          >
