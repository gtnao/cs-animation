...
export default function GoldenSectionSearchPage() {
  return (
    <div className="min-h-screen bg-background">
      <div className="max-w-2xl mx-auto px-4 py-16">
        <h1 className="text-2xl font-bold mb-2">黄金分割探索</h1>
        <p className="text-sm text-muted-foreground mb-8">
          黄金比を利用して凸関数の極値を効率的に求めるアルゴリズム
        </p>
        <div className="space-y-2">
          <Link
            href="/golden-section-search/animation"
          ...
          <Link
            href="/golden-section-search/article"
            className="block p-4 border border-border rounded hover:bg-accent transition-colors"
          >
