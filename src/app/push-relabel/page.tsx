...
export default function PushRelabelPage() {
  return (
    <div className="min-h-screen bg-background">
      <div className="max-w-2xl mx-auto px-4 py-16">
        <h1 className="text-2xl font-bold mb-2">Push-Relabel</h1>
        <p className="text-sm text-muted-foreground mb-8">
          プリフローとラベル関数を用いた最大フローアルゴリズム
        </p>
        <div className="space-y-2">
          <Link
            href="/push-relabel/animation"
