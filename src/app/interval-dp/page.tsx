  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="max-w-2xl mx-auto px-4 py-16">
        <h1 className="text-2xl font-bold mb-2">区間DP</h1>
        <p className="text-sm text-muted-foreground mb-8">
          区間を分割・統合する問題を動的計画法で解くテクニック
        </p>
        <div className="space-y-2">
          <Link href="/interval-dp/animation" className="block p-4 border border-border rounded hover:bg-accent transition-colors">
            <h2 className="font-semibold">アニメーション</h2>
            <p className="text-sm text-muted-foreground">ステップ実行でアルゴリズムの動作を可視化</p>
          </Link>
          <Link href="/interval-dp/article" className="block p-4 border border-border rounded hover:bg-accent transition-colors">
