...
export default function BidirectionalBfsPage() {
  return (
    <div className="min-h-screen bg-background">
      <div className="max-w-2xl mx-auto px-4 py-16">
        <h1 className="text-2xl font-bold mb-2">双方向BFS</h1>
        <p className="text-sm text-muted-foreground mb-8">
          始点とゴールの両方から同時にBFSを行い、探索空間を削減するアルゴリズム
        </p>
        <div className="space-y-2">
          <Link
            href="/bidirectional-bfs/animation"
          ...
          <Link
            href="/bidirectional-bfs/article"
            className="block p-4 border border-border rounded hover:bg-accent transition-colors"
          >
