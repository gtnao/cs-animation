...
export default function MinkowskiSumPage() {
  return (
    <div className="min-h-screen bg-background">
      <div className="max-w-2xl mx-auto px-4 py-16">
        <h1 className="text-2xl font-bold mb-2">ミンコフスキー和</h1>
        <p className="text-sm text-muted-foreground mb-8">
          2つの凸多角形のミンコフスキー和を計算するアルゴリズム
        </p>
        <div className="space-y-2">
          <Link
            href="/minkowski-sum/animation"
