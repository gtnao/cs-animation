...
export default function LCPArrayPage() {
  return (
    <div className="min-h-screen bg-background">
      <div className="max-w-2xl mx-auto px-4 py-16">
        <h1 className="text-2xl font-bold mb-2">LCP Array (Kasai)</h1>
        <p className="text-sm text-muted-foreground mb-8">
          Suffix Arrayから最長共通接頭辞配列を線形時間で構築
        </p>
        <div className="space-y-2">
          <Link
            href="/lcp-array/animation"
