...
export default function ExtGCDPage() {
  return (
    <div className="min-h-screen bg-background">
      <div className="max-w-2xl mx-auto px-4 py-16">
        <h1 className="text-2xl font-bold mb-2">拡張ユークリッドの互除法</h1>
        <p className="text-sm text-muted-foreground mb-8">
          ax + by = gcd(a, b) を満たす整数 x, y を求めるアルゴリズム
        </p>
        <div className="space-y-2">
          <Link
            href="/ext-gcd/animation"
