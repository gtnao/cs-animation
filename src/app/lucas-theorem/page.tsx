...
export default function LucasTheoremPage() {
  return (
    <div className="min-h-screen bg-background">
      <div className="max-w-2xl mx-auto px-4 py-16">
        <h1 className="text-2xl font-bold mb-2">Lucasの定理</h1>
        <p className="text-sm text-muted-foreground mb-8">
          素数 p に対して二項係数を p 進展開で分解して計算する定理
        </p>
        <div className="space-y-2">
          <Link
            href="/lucas-theorem/animation"
