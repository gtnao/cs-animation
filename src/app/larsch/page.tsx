...
export default function LARSCHPage() {
  return (
    <div className="min-h-screen bg-background">
      <div className="max-w-2xl mx-auto px-4 py-16">
        <h1 className="text-2xl font-bold mb-2">LARSCH Algorithm</h1>
        <p className="text-sm text-muted-foreground mb-8">
          totally monotone 行列の行最小値をオンラインで求める線形時間アルゴリズム
        </p>
        <div className="space-y-2">
          <Link
            href="/larsch/animation"
