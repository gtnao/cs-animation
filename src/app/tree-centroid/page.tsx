...
export default function TreeCentroidPage() {
  return (
    <div className="min-h-screen bg-background">
      <div className="max-w-2xl mx-auto px-4 py-16">
        <h1 className="text-2xl font-bold mb-2">木の重心</h1>
        <p className="text-sm text-muted-foreground mb-8">
          木の重心（部分木サイズの最大値を最小化する頂点）を求めるアルゴリズム
        </p>
        <div className="space-y-2">
          <Link
            href="/tree-centroid/animation"
