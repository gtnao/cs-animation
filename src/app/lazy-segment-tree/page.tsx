...
export default function LazySegmentTreePage() {
  return (
    <div className="min-h-screen bg-background">
      <div className="max-w-2xl mx-auto px-4 py-16">
        <h1 className="text-2xl font-bold mb-2">遅延評価セグメント木</h1>
        <p className="text-sm text-muted-foreground mb-8">
          区間更新と区間クエリを O(log n) で処理するデータ構造
        </p>
        <div className="space-y-2">
          <Link
            href="/lazy-segment-tree/animation"
          ...
          <Link
            href="/lazy-segment-tree/article"
            className="block p-4 border border-border rounded hover:bg-accent transition-colors"
          >
