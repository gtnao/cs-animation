...
export default function ArbitraryModConvolutionPage() {
  return (
    <div className="min-h-screen bg-background">
      <div className="max-w-2xl mx-auto px-4 py-16">
        <h1 className="text-2xl font-bold mb-2">任意modでの畳み込み</h1>
        <p className="text-sm text-muted-foreground mb-8">
          NTT-friendly でない mod でも畳み込みを行う手法
        </p>
        <div className="space-y-2">
          <Link
            href="/arbitrary-mod-convolution/animation"
          ...
          <Link
            href="/arbitrary-mod-convolution/article"
            className="block p-4 border border-border rounded hover:bg-accent transition-colors"
          >
